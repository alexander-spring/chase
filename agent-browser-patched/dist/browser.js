import { chromium, firefox, webkit, devices, } from 'patchright-core';
...
export class BrowserManager {
    ...
    async connectViaCDP(cdpEndpoint) {
        ...
        try {
            ...
            for (const context of contexts) {
                // DISABLED: setDefaultTimeout may trigger detectable CDP commands
                // context.setDefaultTimeout(10000);
                this.contexts.push(context);
                this.setupContextTracking(context);
            }
     ...
     * NOTE: Event listeners disabled to avoid CDP bindings that trigger bot detection
     */
    setupPageTracking(page) {
        // DISABLED: These CDP bindings may trigger bot detection (Runtime.consoleAPICalled, etc.)
        // page.on('console', (msg) => {
        //   this.consoleMessages.push({
        //     type: msg.type(),
        //     text: msg.text(),
    ...
    setupContextTracking(context) {
        // DISABLED: Context event listeners may trigger bot detection
